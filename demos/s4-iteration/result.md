# Result: Three Iterations Compared
...
- Energy customer concentration: CAT Energy Services at 33.9% of division revenue
...
3. **Investigate Energy CSAT decline.** At 3.5/5.0, Energy has the lowest satisfaction score. Cross-reference Zendesk tickets with late shipments to determine root cause. Present findings at the February operations review.
...
| Draft | Prompt | Output |
|---|---|---|
| 1 | "Summarize Q4 performance" | Data dump — no prioritization |
| 2 | + "Traffic-light, flag >10% off plan" | Structured dashboard — scannable |
| 3 | + "One page, lead with risk, end with actions" | Executive brief — board-ready |

Same data. Same agent. **The prompt was the variable that mattered.**
